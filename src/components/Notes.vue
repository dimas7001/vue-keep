      ...
      <div class="note" @mouseleave="closeControls(note.id)" :id="note.id">
        ...
        <div class="note__controls">
          ...
          <div class="note__archive" :class="notesType === 'deleted'? 'note__archive_hidden' : ''" @click="toggleArchived(note.id)">
            <img v-if="notesType !== 'archived'" src="../assets/img/archive/archive_w.png" alt="archive">
            <img v-else src="../assets/img/unarchive/unarchive_w.png" alt="unarchive">
          </div>
          <div class="note__delete" @click="toggleBin(note.id)">
            <img v-if="notesType !== 'deleted'" src="../assets/img/delete/delete_w.png" alt="delete">
            <img v-else src="../assets/img/restore/restore_w.png" alt="restore">
          </div>
        </div>
      </div>
    </div>
